...
collaborating model Sol), which has reduced it, on paper, through a chain of
exact certificate-shaped reductions --- per-digit gates at the true
singularities of the underlying Ap\'ery-like recurrence, then a single $a=1$
midpoint gate, currently one explicit congruence from closure --- each step
verified in exact arithmetic before use. The adversarial evidence base for
